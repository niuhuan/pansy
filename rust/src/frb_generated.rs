...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        9 => wire__crate__api__api__illust_from_url_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__api__illust_rank_first_url_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__api__illust_recommended_first_url_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ...
        13 => wire__crate__api__api__illust_trending_tags_impl(port, ptr, rust_vec_len, data_len),
        14 => {
            wire__crate__api__api__illust_trending_tags_url_impl(port, ptr, rust_vec_len, data_len)
        }
        15 => wire__crate__api__api__init_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__api__load_pixiv_image_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__api__load_property_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__api__login_by_code_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__api__per_in_china_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__api__pre_login_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__api__recreate_downloads_to_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__api__request_url_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__api__reset_failed_downloads_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__api__save_property_impl(port, ptr, rust_vec_len, data_len),
        25 => wire__crate__api__api__set_downloads_to_impl(port, ptr, rust_vec_len, data_len),
        26 => wire__crate__api__api__set_in_china_impl(port, ptr, rust_vec_len, data_len),
        27 => wire__crate__api__api__user_detail_impl(port, ptr, rust_vec_len, data_len),
        28 => wire__crate__api__api__user_illusts_first_url_impl(port, ptr, rust_vec_len, data_len),
