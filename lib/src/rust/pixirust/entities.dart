...
class IllustTrendingTags {
  ...
  const IllustTrendingTags({required this.trendTags});
...
class LoginUrl {
  ...
  const LoginUrl({required this.verify, required this.url});
...
class Series {
  ...
  const Series({required this.id, required this.title});
