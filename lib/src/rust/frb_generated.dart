...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiApiCopyImageTo(
      {required String srcPath, required String toDir});
  ...
  Future<void> crateApiApiInit(
      {required String root, required String downloadsTo});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiApiCreateLoginUrlConstMeta => const TaskConstMeta(
        debugName: "create_login_url",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiDownloadingListConstMeta => const TaskConstMeta(
        debugName: "downloading_list",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiDownloadsToConstMeta => const TaskConstMeta(
  ...
  TaskConstMeta get kCrateApiApiGetInChinaConstMeta => const TaskConstMeta(
        debugName: "get_in_china",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiIllustFromUrlConstMeta => const TaskConstMeta(
        debugName: "illust_from_url",
        argNames: ["url"],
      );
  ...
  TaskConstMeta get kCrateApiApiIllustTrendingTagsConstMeta =>
      const TaskConstMeta(
        debugName: "illust_trending_tags",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiIllustTrendingTagsUrlConstMeta =>
      const TaskConstMeta(
        debugName: "illust_trending_tags_url",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiLoadPixivImageConstMeta => const TaskConstMeta(
        debugName: "load_pixiv_image",
        argNames: ["url"],
      );
  ...
  TaskConstMeta get kCrateApiApiLoginByCodeConstMeta => const TaskConstMeta(
        debugName: "login_by_code",
        argNames: ["query"],
      );
  ...
  TaskConstMeta get kCrateApiApiPerInChinaConstMeta => const TaskConstMeta(
        debugName: "per_in_china",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiPreLoginConstMeta => const TaskConstMeta(
        debugName: "pre_login",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiRecreateDownloadsToConstMeta =>
      const TaskConstMeta(
        debugName: "recreate_downloads_to",
        argNames: [],
      );
  ...
  TaskConstMeta get kCrateApiApiRequestUrlConstMeta => const TaskConstMeta(
        debugName: "request_url",
        argNames: ["params"],
      );
  ...
  TaskConstMeta get kCrateApiApiSetInChinaConstMeta => const TaskConstMeta(
        debugName: "set_in_china",
        argNames: ["value"],
      );
  ...
  TaskConstMeta get kCrateApiApiUserDetailConstMeta => const TaskConstMeta(
  ...
  IllustTrendingTags dco_decode_illust_trending_tags(dynamic raw) {
    ...
    return IllustTrendingTags(
      trendTags: dco_decode_list_trend_tag(arr[0]),
    );
  }
  ...
  MetaPage dco_decode_meta_page(dynamic raw) {
    ...
    if (arr.length != 1)
      throw Exception('unexpected arr length: expect 1 but see ${arr.length}');
    return MetaPage(
      imageUrls: dco_decode_meta_page_image_urls(arr[0]),
    );
  }
  ...
  MetaSinglePage dco_decode_meta_single_page(dynamic raw) {
    ...
    return MetaSinglePage(
      originalImageUrl: dco_decode_opt_String(arr[0]),
    );
  }
  ...
  ProfileImageUrls dco_decode_profile_image_urls(dynamic raw) {
    ...
    return ProfileImageUrls(
      medium: dco_decode_String(arr[0]),
    );
  }
  ...
  MainImageUrls sse_decode_main_image_urls(SseDeserializer deserializer) {
    ...
    return MainImageUrls(
        squareMedium: var_squareMedium, medium: var_medium, large: var_large);
  }
  ...
  TrendTag sse_decode_trend_tag(SseDeserializer deserializer) {
    ...
    return TrendTag(
        tag: var_tag, translatedName: var_translatedName, illust: var_illust);
  }
  ...
  void sse_encode_list_meta_page(
      List<MetaPage> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
  ...
  void sse_encode_list_trend_tag(
      List<TrendTag> self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
  ...
  void sse_encode_main_image_urls(
      MainImageUrls self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
